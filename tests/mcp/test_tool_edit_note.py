...
async def test_edit_note_invalid_operation(client):
    ...
    with pytest.raises(ValueError) as exc_info:
        await (edit_note.fn if hasattr(edit_note, "fn") else edit_note)(
...
async def test_edit_note_empty_content_operations(client):
    ...
    result = await (edit_note.fn if hasattr(edit_note, "fn") else edit_note)(identifier="test/test-note", operation="append", content="")
...
async def test_edit_note_preserves_permalink_when_frontmatter_missing(client):
    ...
    first_result = await (edit_note.fn if hasattr(edit_note, "fn") else edit_note)(
        identifier="test/test-note",
        operation="append",
        content="\nFirst edit.",
    )
    ...
    second_result = await (edit_note.fn if hasattr(edit_note, "fn") else edit_note)(
        identifier="test/test-note",
        operation="append",
        content="\nSecond edit.",
    )
